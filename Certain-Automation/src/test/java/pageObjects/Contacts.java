...
public class Contacts {
	...
	@FindBy(how = How.XPATH, using ="//*[text()='First Name']//following::input[1]") WebElement firstName;
	@FindBy(id="surname") WebElement lastName;
	@FindBy(how = How.XPATH,using="//img[@title='Date selector']") WebElement clickOnCale;
	
	
	@FindBy(how = How.XPATH,using="//div[@class='calendar'][2]//tbody//tr[@class='daysrow']//td") List <WebElement> allDates;
	@FindBy(how = How.XPATH,using="//div[@class='calendar'][2]//tbody//tr[@class='daysrow']//td[text()='4']") WebElement specificDate;
	
	@FindBy(how=How.XPATH, using ="//input[@value='Load From Company']//following::input[1]") WebElement saveButton;
